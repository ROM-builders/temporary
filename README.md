[![Build Status](https://api.cirrus-ci.com/github/ROM-builders/temporary.svg)](https://cirrus-ci.com/github/ROM-builders/temporary) AospExtended custom ROM for Redmi Note 4
==============================
