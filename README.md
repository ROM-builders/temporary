LineageOS 4.9 kernel custom ROM for Moto Z Play
==============================

LineageOS [Custom ROM](https://beebom.com/best-custom-roms-android-phones/) for Moto Z Play(code name addison)
