AospExtended custom ROM for Redmi Note 8
==============================

AospExtended [Custom ROM](https://twitter.com/abhishekhembro4) for Redmi Note 8(code name ginkgo)
...
How to use this repository this.
-------------------
