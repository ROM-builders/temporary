...
git clone https://github.com/HoangLong-Lumi/LocalManifests.git --depth 1 -b master .repo/local_manifests
...
export BUILD_USERNAME=Lumi
export BUILD_HOSTNAME=Yoimiya
make bacon
