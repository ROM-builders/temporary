...
git clone https://github.com/zaidannn7/local_manifestgit --depth 1 -b carbon .repo/local_manifests
...
export KBUILD_BUILD_USER=zaidannn7
export KBUILD_BUILD_HOST=zaidannn7
