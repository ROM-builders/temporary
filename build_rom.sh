...
git clone https://github.com/crastex/Local-Manifests.git --depth 1 -b master .repo/local_manifests
...
export EVO_BUILD_MAINTAINER=Crasten
export BUILD_USERNAME=crast
export BUILD_HOSTNAME=ex
