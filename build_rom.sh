...
git clone https://github.com/eurekadevelopment/local_manifests.git -b rom-builders .repo/local_manifests
repo sync -c --no-clone-bundle --no-tags --optimized-fetch --prune --force-sync -j8

# build rom
source build/envsetup.sh
lunch evolution_a20e-user
export TZ=Asia/Seoul #put before last build command
mka libtensorflowlite_jni
mka evolution
