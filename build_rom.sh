...
git -C .repo/manifests reset --hard 783e300f03727cf861caeca8d6b7a85ea52b1efe
git clone https://github.com/NRanjan-17/local_manifest.git --depth 1 -b PixelExperience-13 .repo/local_manifests
