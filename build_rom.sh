...
git clone https://github.com/rushiranpise/local_manifest --depth 1 -b sakura .repo/local_manifests
...
rclone copy out/target/product/chef/*.zip cirrus:chef/sakura -P
