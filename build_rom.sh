# sync rom
repo init --depth=1 -u git://github.com/yaap/manifest.git -b eleven -g default,-device,-mips,-darwin,-notdefault
...
rclone copy out/target/product/surya/*Rocinante*.zip cirrus:surya -P
