...
git clone https://github.com/donboruza/local_manifests.git --depth 1 -b rice-13 .repo/local_manifests
repo sync -c --no-clone-bundle --force-remove-dirty --no-tags --optimized-fetch --prune --force-sync -j8
