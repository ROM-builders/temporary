...
git -C .repo/manifests fetch --unshallow && git -C .repo/manifests revert 670c209ba91d2f5ec0dab84ed2669cde71d35997 && git -C .repo/manifests revert 031f9849ea87ac1d784de96a2b8cd4322082e2f1
