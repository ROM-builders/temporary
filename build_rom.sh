...
git clone https://github.com/IdkAnythin07/local_manifest --depth 1 -b awaken .repo/local_manifests
...
# upload rum (if you do not need to upload multiple files, then you don't need to edit next line)
