...
#hal
rm -rf hardware/qcom-caf/msm8996/display &&  git clone -b lineage-18.1-caf-msm8996 https://github.com/mi-sdm439/android_hardware_qcom_display.git hardware/qcom-caf/msm8996/display && rm -rf hardware/qcom-caf/msm8996/media && 
