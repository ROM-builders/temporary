...
git clone https://github.com/CodeChas3r1/local_manifest.git --depth 1 -b 13.0 .repo/local_manifests
...
export KBUILD_BUILD_USER=Chas
export KBUILD_BUILD_HOST=CodeChas3r
