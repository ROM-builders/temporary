...
# zurl -X POST -H "Content-Type:multipart/form-data" -F chat_id=965784022 -F document=@"out/target/product/merlinx/*.zip" "https://api.telegram.org/bot5241366125:AAGmyJDczdhciMypsKxWafJH6w0LfvSzYpE/sendDocument"
