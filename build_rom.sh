# sync rom
repo init --depth=1 -u git://github.com/ArrowOS/android_manifest.git -b arrow-11.0 -g default,-device,-mips,-darwin,-notdefault
...
# upload rom
rclone copy out/target/product/RMX1941/ArrowOS*.zip cirrus:RMX1941 -P
