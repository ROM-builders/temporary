...
# sync rom
repo init -u https://github.com/ArrowOS/android_manifest.git -b arrow-11.0 --depth=1 -g default,-device,-mips,-darwin,-notdefault

git clone https://github.com/P-Salik/local_manifest --depth=1 -b main .repo/local_manifests

rm -rf plaform/external/apache-commons-bcel
