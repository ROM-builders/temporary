...
git clone https://github.com/Tiktodz/local_manifest.git --depth 1 -b rice .repo/local_manifests
...
# uploaded rom (if you don't need to upload multiple files, then you don't need to edit next line)
