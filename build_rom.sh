 # sync Rom      
repo init --depth=1 --no-repo-verify -u https://github.com/CherishOS/android_manifest -b tiramisu --git-lfs -g default,-mips,-darwin,-notdefault
...
brunch cherish_merlinx-userdebug 
