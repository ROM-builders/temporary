...
git clone https://github.com/tedomi2705/local_manifest.git --depth=1 -b snow-rebase .repo/local_manifests
...
rclone copy out/target/product/tulip/*.zip.json cirrus:tulip -P