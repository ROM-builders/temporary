...
git clone https://github.com/TelkomFlexi/local_manifest --depth 1 -b cherish .repo/local_manifests
repo sync -c --no-clone-bundle --no-tags --optimized-fetch --prune --force-sync -j12

# build rom
source build/envsetup.sh
lunch cherish_ginkgo-userdebug
export BUILD_USERNAME=SupraX 125
export BUILD_HOSTNAME=Honda SupraX 125
