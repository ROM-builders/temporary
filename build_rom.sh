...
git clone https://github.com/Miiyo/local_manifest.git --depth 1 -b master .repo/local_manifests
repo sync -c --no-clone-bundle --force-remove-dirty --optimized-fetch --prune --force-sync -j8
# build rom
source build/envsetup.sh
lunch lineage_akari_kddi-defconfig
export BUILD_USERNAME=ekkusa
