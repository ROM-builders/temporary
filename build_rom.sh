...
repo init -u https://github.com/omnirom/android.git -b android-13.0 repo sync  cd <source-dir>; . build/envsetup.sh; brunch vayu -g default,-mips,-darwin,-notdefault
git clone https://github.com/dudu2504/Vayu/blob/d2265ae6a9cd01210a9d94f967506d00eaaafe4b/local_manifest.xml --depth 1 -b padrão .repo/local_manifests
