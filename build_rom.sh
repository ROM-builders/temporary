...
git clone https://github.com/PinCredible/local-manifest.git --depth 1 -b merlinx-pex .repo/local_manifests
...
rclone copy OTA/builds/merlinx.json cirrus:merlinx -P
