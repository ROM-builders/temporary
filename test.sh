...
for item in "LineageOS lineage-15.1" "LineageOS lineage-17.1" "LineageOS lineage-18.1" "LineageOS lineage-19.1" "ArrowOS arrow-12.0" "Project-Fluid fluid-12" "CipherOS twelve-L" "ProjectRadiant twelve" "Project-Awaken 12" "Octavi-OS 12" "Project-LegionOS 12" "ShapeShiftOS android_12" "lighthouse-os sailboat_L1" "Evolution-X snow" "PotatoProject frico-release" "StyxProject S" "PixelExperience twelve" "CherishOS twelve-one" "Spark-Rom spark" "PixelExtended snow" "Corvus-R 12" "crdroidandroid 12.0" "AospExtended 12.x" "NusantaraProject-ROM 12" "ProjectSakura 12" "ForkLineageOS lineage-19.0"
do
