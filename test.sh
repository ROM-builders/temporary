...
if [[ $init_check != *default,-mips,-darwin,-notdefault* ]]; then echo Please use --depth=1 and -g default,-device,-mips,-darwin,-notdefault tags in repo init line.; exit 1; fi
...
if [[ $rom_name == Project-LegionOS ]]; then if [[ $branch_name == '12' ]]; then echo Only ArrowOS a11 and a12 is supported.; exit 1; fi ;fi
