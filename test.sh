...
if [[ $BRANCH == *pull/* ]]; then
	...
	for id in 66806243 73420351 69832543 100027207 77049889 37245252 87101173 91236805 56505303 77262770 60956846 1133897 92011891 80823029 58514579 102499518
	do
